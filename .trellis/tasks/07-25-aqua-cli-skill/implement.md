...
./target/debug/aqua groups "$FIXTURE"
./target/debug/aqua tables --group <g> "$FIXTURE"
./target/debug/aqua show <table> "$FIXTURE"
./target/debug/aqua gen entity <table> "$FIXTURE"
./target/debug/aqua gen datamodel <table> "$FIXTURE"
